...
export function App2() {
    return <div>
        {/* this is way 1 of doing it but if we want to render multiple items */}
        {/* <div id="essay" style={{ fontSize: 20, padding: 20,height:"80vh",overflow:"scroll" }}>
            I’m a Senior Applied Scientist at Amazon where I build production machine learning systems. And I don’t write code anymore.
        ...
        <Essay/>
        <Essay/>
{/* all of these top button will take the most above to the top as the id to all div is same
thats why we never use a static id for multiple divs, we fix this problem by useref
as we can also give reference to a dom element also */}
    </div>
...
function Essay(){
    ...
    return <div>
        <div ref={divref} id="essay" style={{ fontSize: 20, padding: 20,height:"80vh",overflow:"scroll" }}>
            I’m a Senior Applied Scientist at Amazon where I build production machine learning systems. And I don’t write code anymore.
